...
def train_neural_network(X_train, Y_train, X_test, Y_test, W1_init, b1_init, W2_init, b2_init, W3_init, b3_init, iterations=1000, learning_rate=0.1):
    ...
    plt.title('Train Cost w.r.t. Iterations ( lr='+str(learning_rate)+' )')
    plt.plot(range(iterations), train_costs)
    plt.xlabel('Iterations')
    plt.ylabel('Training Cost')
    plt.savefig('Task_2/train_costs'+str(learning_rate)+'.png')

    # Plot test cost w.r.t. iterations
    plt.title('Test Cost w.r.t. Iterations ( lr='+str(learning_rate)+' )')
    plt.plot(range(iterations), test_costs)
    plt.xlabel('Iterations')
    plt.ylabel('Test Cost')
    plt.savefig('Task_2/test_costs'+str(learning_rate)+'.png')    

    # Plot train and test accuracies
    plt.title('Train and Test Accuracies w.r.t. Iterations ( lr='+str(learning_rate)+' )')
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('Task_2/accuracies'+str(learning_rate)+'.png') 
...
def main():
    ...
    print("Training with learning rate 1")
    train_neural_network(X_train, Y_train, X_test, Y_test, W1_init, b1_init, W2_init, b2_init, W3_init, b3_init, iterations=1000, learning_rate=1)
    print("Training with learning rate 0.1")
    train_neural_network(X_train, Y_train, X_test, Y_test, W1_init, b1_init, W2_init, b2_init, W3_init, b3_init, iterations=1000, learning_rate=0.1)
    print("Training with learning rate 0.001")
    train_neural_network(X_train, Y_train, X_test, Y_test, W1_init, b1_init, W2_init, b2_init, W3_init, b3_init, iterations=1000, learning_rate=0.001)
